...
@Setter
@Builder
public class RelationalOperationPig extends NodeASTPig {
    private NodeASTPig left;
    private String operator;
    private NodeASTPig right;

    @Builder
    public RelationalOperationPig(NodeASTPig left, String operator, NodeASTPig right, int line, int column) {
        super(line, column);
        this.left = left;
